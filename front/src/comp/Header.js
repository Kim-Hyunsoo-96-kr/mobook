                ...
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <div class="my-5 text-center text-xl-start">
                            <h1 class="display-6 fw-bolder text-white mb-2">1월 추천 도서<br/><br/>알고리즘 with 수학</h1>
                    ...
                    <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5 height450" src="https://shopping-phinf.pstatic.net/main_4276435/42764353624.20230928092002.jpg" alt="..." /></div>
                </div>
            </div>
        </header>
    );
