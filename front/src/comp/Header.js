                ...
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <div class="my-5 text-center text-xl-start">
                            <h1 class="display-6 fw-bolder text-white mb-2">12월 추천 도서 : 코틀린 코루틴</h1>
                    ...
                    <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5 height450" src="https://shopping-phinf.pstatic.net/main_4332773/43327739619.20231019092056.jpg" alt="..." /></div>
                </div>
            </div>
        </header>
    );
