                ...
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <div class="my-5 text-center text-xl-start">
                            <h1 class="display-6 fw-bolder text-white mb-2">11월 추천 도서 : 코틀린 디자인 패턴</h1>
                    ...
                    <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5 height450" src="https://shopping-phinf.pstatic.net/main_4182044/41820441620.20230926085023.jpg" alt="..." /></div>
                </div>
            </div>
        </header>
    );
